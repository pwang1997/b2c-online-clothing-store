...
export default function SignIn() {
    ...
    const handleFormClose = props.handleClose;
    ...
    const handleLogin = (e) => {
        const loginUserWithEmailPassword = async() => {
            ...
            const q = query(userCollectionRef, where("capital", "==", true));
            await getDoc(userCollectionRef, q);
        }

        loginUserWithEmailPassword().then(() => {
            handleFormClose();
        });
